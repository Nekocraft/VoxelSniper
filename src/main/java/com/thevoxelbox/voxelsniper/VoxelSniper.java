...
public class VoxelSniper extends JavaPlugin
{
	...
	public VoxelSniper()
	{
		...
		try
		{
			this.bParser.registerParameter(new FlaggedOption("size", JSAP.INTEGER_PARSER, null, false, 's', "size", "Defines the size of the brush."));
